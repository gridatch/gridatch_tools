import { DRAGON_TILES, isDragonTile, isPinzuTile, isSanmaManzuTile, isSozuTile, isWindTile, PINZU_TILES, RealmBoss, SANMA_MANZU_TILES, SANMA_TILES, SanmaTile, SOZU_TILES, WIND_TILES } from "../../../types/simulation";
