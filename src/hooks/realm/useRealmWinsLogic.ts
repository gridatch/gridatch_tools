...
import { isSozuTile, RealmEditPhase, RealmPhase, RealmTenpai, SanmaTile, SanmaTileOrNonRealm, Sozu, SOZU_RECORD_0, SOZU_TILES } from "../../types/simulation";
import { RealmProgressState } from "./useRealmProgressState";
import { RealmWallState } from "./useRealmWallState";
import { RealmRemainingTilesLogic } from "./useRealmRemainingTilesLogic";


export interface RealmWinsLogic {
...
export const useRealmWinsLogic = (
