...
import { Hand, isSanmaTile, isSozuTile, PINZU_TILES, RealmPhase, RealmPhaseAction, RealmSimulationProgress, RealmTenpaiResult, SANMA_TILE_RECORD_0, SANMA_TILES, SanmaTile, SOZU_TILES, WallTile } from "../../types/simulation";
