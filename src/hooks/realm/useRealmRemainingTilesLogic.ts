...
import { Hand, SANMA_TILE_RECORD_4, SANMA_TILES, SanmaTile, WallTile } from "../../types/simulation";


export interface RealmRemainingTilesLogic {
...
export const useRealmRemainingTilesLogic = (
  turn: number,
