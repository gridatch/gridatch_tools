...
import { Hand, isSanmaTile, isSozuTile, PINZU_TILES, RealmPhase, RealmPhaseAction, RealmSimulationProgress, RealmTenpaiResult, SANMA_TILE_RECORD_0, SANMA_TILES, SanmaTile, Sozu, SOZU_TILES, WallTile } from "../types/simulation";
...
export const useMainPhaseActions = (
  ...
  }, [categorizeRealmTiles, isRealmEachTile, nonRealmWinsByTenpaiTurnsPerSozu, progressState, realmWinsByTenpaiTurns, remainingTiles, results, wall]);
